...
from mathematicians import simple_get, log_error
...
def get_names():
    ...
    if response is not None:
        ...
        names = set()
        for li in html.select('li'):  # if in <li> tag more then one name, they are separeted with \n
...
'''
html_raw = simple_get('http://www.fabpedigree.com/james/mathmen.htm')
